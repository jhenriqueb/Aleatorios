...
def mostrar_cardapio_pratos():
    # Exibe o cardápio de pratos disponíveis com preços e tempos de preparo
    print("\n=== Cardápio de Pratos ===")
    for prato in PRATOS:
        ...
        if opcao == "1":
            ...
            try:
                ...
                if 0 <= escolha < len(BEBIDAS):
                    ...
                    # Mapeamento das opções de tamanho
                    tamanho = {
                        "1": TamanhoBebida.P,
                        "2": TamanhoBebida.M,
                        "3": TamanhoBebida.G
...
def main():
    # Cria uma instância do restaurante
    ...
    while True:
        ...
        if opcao == "1":
            ...
            # Visualização e gerenciamento da conta
            ...
            # Lista as mesas que estão ocupadas
